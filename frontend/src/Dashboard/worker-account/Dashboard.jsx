                ...
                {tab === "overview" && (
                  <div>
                    <div className="flex items-center gap-4 mb-10">
                      ...
                      <div>
                        <span className="bg-[#CCF0F3] text-irisBlueColor py-1 px-4 lg:py-2 lg:px-8 rounded text-[12px] leading-4 lg:text-[16px] lg:leading-6 font-semibold">
                          {data.specialization}
                        </span>

                        <h3 className="text-[22px] leadin-9 font-bold text-headingColor mt-3">
                          {data.name}
                        </h3>
